...
//		colors.add(Colors.LIGHTGREY);
		...
		while (lastTime - startTime < runTime) {
			...
			if (closestColor == Colors.RED) {
				...
				redLinesPassed++;
//	        	
				getMarvin().getMotorControl().drive(550, 550); // rechtdoor
				Delay.msDelay(400);
//	       
//				Delay.msDelay(100);
//
...
//	        	Delay.msDelay(100);
				...
				} else if (closestColor == Colors.DARKGREY) { // rechtdoor iets naar links
...
//					Delay.msDelay(100);
					...
					textLCD.drawString("wit", 1, 5);
					getMarvin().getMotorControl().drive(-400, 1);
					Delay.msDelay(400);
					...
					getMarvin().getMotorControl().drive(1, -400);
					Delay.msDelay(400);
					getMarvin().getMotorControl().drive(200, 200);
					Delay.msDelay(150);
				}
...
//		} else if (closestColor == Colors.WHITE) { // naar rechts
//			textLCD.drawString("Wit", 1, 5);
//			getMarvin().getMotorControl().drive(1, -250);
//			Delay.msDelay(100);
//			getMarvin().getMotorControl().drive(150, 150);
...
//					textLCD.drawString("Zwart", 1, 5);
//					getMarvin().getMotorControl().drive(-250, 1);
//					Delay.msDelay(100);
//					getMarvin().getMotorControl().drive(150, 150);
//					Delay.msDelay(100);
//				}
